...
const ProfileItem = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://go-travel-server-tau.vercel.app/booking", {
      method: "POST",
      // headers:{
    ...
    <div>
      ...
      <Container maxWidth="lg" className="mt-6">
        ...
        <form
          ...
          className="grid grid-cols-1 sm:grid-cols-2  md:grid-cols-4 gap-4 mt-8 mb-12"
        >
          <input
            type="name"
          ...
          <button
            type="submit"
            className="px-6 py-3 bg-smooth-yellow-100 text-lg text-white font-semibold"
          >
            Add
          </button>
        </form>
