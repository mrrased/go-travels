    ...
    <Container maxWidth="lg">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 py-10">
        <div className="col-span-6">
          <div>
            <h3 className="text-sm uppercase text-smooth-yellow-150 font-semibold mb-1 tracking-widest">
              Asked Question
            </h3>
            <h1 className="text-xl md:text-4xl font-bold text-smooth-black mb-3">
              Flight Asked Question
            </h1>
            <p className="mb-7 font-base">
              Lorem ipsum dolor sit amet, consectetur adipiscing elitIn
              imperdiet interdum imperdiet ipsum.
            </p>
          </div>
          ...
          <div>
            <div className="relative w-full overflow-hidden ">
              <input
                type="checkbox"
                className="absolute top-0 inset-x-0 w-full h-[68px] z-10 cursor-pointer opacity-0 peer"
              />
              ...
              <div className="bg-smooth-gray-15 h-[68px] w-full pl-2 pr-8 md:pl-5 flex items-center text-pink-blue-50 peer-checked:bg-pink-blue-50 peer-checked:text-white transition-all duration-500">
                <FontAwesomeIcon
                  icon={faCircleDot}
                  size="lg"
                  className="mr-4 text-smooth-gray-200"
                />
                <h1 className="text-base md:text-[22px] font-semibold">
                  Pre-Book Your Baggage Donating a Small{" "}
                </h1>
              </div>
            ...
            <div className="relative w-full overflow-hidden mt-3">
              ...
              <div className="bg-smooth-gray-15 h-[68px]  w-full pl-2 pr-8 md:pl-5 flex items-center text-pink-blue-50 peer-checked:bg-pink-blue-50 peer-checked:text-white transition-all duration-500">
                ...
                />
                <h1 className="text-base md:text-[22px] font-semibold">
                  Search and Save on Cheap Car Rentals{" "}
                </h1>
              </div>
            ...
            <div className="relative w-full overflow-hidden mt-3">
              ...
              <div className="bg-smooth-gray-15 h-[68px] w-full pl-2 pr-8 md:pl-5 flex items-center text-pink-blue-50 peer-checked:bg-pink-blue-50 peer-checked:text-white transition-all duration-500">
                ...
                />
                <h1 className="text-base md:text-[22px] font-semibold">
                  Leave it to us when it comes to finding you{" "}
                </h1>
              </div>
        ...
        <div className="col-span-6 w-full h-screen border-box hidden md:block">
          <div className="relative">
            <img src={about_askedImg} alt="" className="absolute z-10" />
            <div className="content:[''] absolute bg-smooth-yellow md:w-[465px] md:h-[470px] xl:w-[560px]  xl:h-[560px] top-3 left-6 z-0">
              02
            </div>
          </div>
        </div>
