...
const AboutOffer = () => {
  ...
  return (
    <Container maxWidth="lg" className="pt-16 md:py-44 px-0">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
        <div className="col-span-5">
          <div className="block md:hidden mb-4">
            {/* <img src={about_img1} alt="" /> */}
            {/* <div className="content:[''] absolute w-[300px] h-[300px] border-[10px] border-smooth-yellow -top-10 right-12"></div> */}
            <img src={about_img2} alt="" />
          </div>

          <div>
            <h2 className="text-sm uppercase text-smooth-yellow-150 font-semibold mb-1 tracking-widest">
              who we are
            </h2>
            <h3 className="text-xl md:text-4xl  font-bold text-smooth-black mb-3">
              Magical Singapore now even more amazing!
            </h3>
            <h4 className="mb-7 font-base">
              Lorem ipsum dolor sit amet, consectetur adipiscing elitIn interdum
              imperdiet ipsum. denounce with rieous indiation and dislike men
              who beguiled demor.
            </h4>
          </div>
          <div className="mb-10">
          ...
          <div className="flex justify-center md:justify-start">
            <button
              ...
              class="group relative h-12 w-48 overflow-hidden border border-smooth-yellow rounded-lg bg-white text-lg font-semibold shadow "
            >
