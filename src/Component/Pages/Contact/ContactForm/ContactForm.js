...
const ContactForm = () => {
  ...
  return (
    <Container maxWidth="lg" className="pt-10 md:pt-20 pb-10 md:pb-20">
      ...
      <div>
        <div>
          <h5 className="uppercase text-smooth-yellow text-sm font-semibold mb-[5px] tracking-wider text-center">
            Contact us Now
          </h5>
          <h2 className="capitalize text-pink-black-100 text-4xl font-bold tracking-wider text-center">
            Write a Message
          </h2>
        </div>
        <form className="md:px-[80px]  py-10" onSubmit={handleSubmit}>
          ...
          >
            <button
              type="submit"
              className="group relative h-12 w-48 overflow-hidden border border-smooth-yellow rounded-lg bg-white text-lg font-semibold shadow"
              disabled={buttonDisabled}
            >
              <div class="absolute inset-0 w-0 bg-smooth-yellow-100 transition-all duration-500 ease-out group-hover:w-full"></div>
              <span class="relative text-black group-hover:text-white uppercase">
