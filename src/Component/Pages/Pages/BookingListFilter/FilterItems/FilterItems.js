        ...
        <div className='sm:p-7'>
            ...
            <div className='p-7 bg-white drop-shadow-lg mt-2'>
                ...
                <div className='text-base font-semibold text-pink-blue'>
                    <button className='bg-gray-100 py-2 px-4 mr-2'><WbTwilightIcon /> 00:00 - 05:59</button><br />
                    <button className='bg-gray-100 py-2 px-4 mt-2 mr-2'><LightModeOutlinedIcon /> 06:00 - 11:59</button><br />
                    <button className='bg-gray-100 py-2 px-4 mt-2 mr-2'><img src={sunset} alt="" className='w-[24px] h-[24px] inline' /> 12:00 - 17:59</button><br />
                    <button className='bg-gray-100 py-2 px-4 mt-2 mr-2'><img src={moon} alt="" className='w-[24px] h-[24px] inline' /> 18:00 - 23:59</button>
                </div>
            </div>
